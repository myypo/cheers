...
pub fn signal_fields_tokens(fields: &[SignalField]) -> impl Iterator<Item = TokenStream> {
...
pub fn signal_methods_tokens(fields: &[SignalField]) -> impl Iterator<Item = TokenStream> {
