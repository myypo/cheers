...
## [0.1.0-alpha.1](https://github.com/myypo/cheers/releases/tag/v0.1.0-alpha.1) - 2026-06-11

### Added

- support scoped view transitions in patch elements
- add js_script!
- generate event target structs for custom events
- split CSS bundles
...
- meld cheers-bundle into cheers crate
