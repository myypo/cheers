...
impl ElementId {
    #[doc(hidden)]
    /// Used by the code generated by `#[derive(Refs)]` for `#[id(...)]` fields and
...
impl<T> Signal<T> {
    #[doc(hidden)]
    /// Used by the code generated by `#[derive(Refs)]` when generating signal
...
impl FormName {
    #[doc(hidden)]
    /// Used by the code generated by `#[derive(Refs)]` and exposed through the
