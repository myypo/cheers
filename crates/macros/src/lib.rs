...
///
/// usable as a component in `html!` by implementing `Render`; `#[derive(Component)]` only
...
#[proc_macro]
/// Binds every signal generated by `#[derive(Component)]` for `self`.
///
...
#[proc_macro]
/// Binds every id generated by `#[derive(Component)]` for `self`.
///
...
#[proc_macro]
/// Binds every form field name generated by `#[derive(Component)]` for `self`.
///
